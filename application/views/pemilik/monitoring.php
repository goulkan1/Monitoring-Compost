		...
		<div class="main-container" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<ul class="nav nav-list">
					<li class="">
						 <a href="<?php echo base_url(); ?>index.php/pemilik">
				...
				<li class="active">
					 <a href="<?php echo base_url(); ?>index.php/aksi/tampil_monitoring">
							<i class="menu-icon fa fa-circle"></i>
							<span class="menu-text"> Monitoring </span>
						</a>
					</li>
					<li class="">
					 <a href="<?php echo base_url(); ?>index.php/aksi/tampil_laporan">
							<i class="menu-icon fa fa-circle"></i>
							<span class="menu-text"> Laporan </span>
						</a>
					</li>
					<!-- <li class="">
						<a href="<?php echo base_url(); ?>index.php/aksi/tampil_pegawai">
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<iframe src="http://localhost/skripsi/index.php/manage_monitoring" width="100%" height="900" style="border:none;"></iframe>	
				...
				<div class="footer-inner">
					...
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">Sistem Monitoring</span>
						</span>
